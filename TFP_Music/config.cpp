...
class CfgMusic
{
	...
	class TFP_Music_65 //Release 5.1 "Personnalisation"
		{
		name="(TFP) Medicopter 117 - Intro";
		sound[]={"\TFP_Music\Medicopter117Theme.ogg",1,1};
		duration = 43;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	...
	class TFP_Music_68
		{
		name="(TFP) Alerte Cobra - Theme Principal";
		sound[]={"\TFP_Music\AlerteCobra_Theme.ogg",1,1};
		duration = 332;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	class TFP_Music_69
		{
		name="(TFP) Tetes Brulees - Theme Principal";
		sound[]={"\TFP_Music\TetesBrulees_Theme.ogg",1,1};
		duration = 56;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	class TFP_Music_70
		{
		name="(TFP) Die Rettungsflieger - Theme Principal";
		sound[]={"\TFP_Music\DieRettungsflieger_Theme.ogg",1,1};
		duration = 55;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	class TFP_Music_71
		{
		name="(TFP) Hurricane (Instrumental)";
		sound[]={"\TFP_Music\30STM_HurricaneInstru.ogg",1,1};
		duration = 368;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	class TFP_Music_72 // Musiques BONUS
		{
		name="(TFP) BONUS - New York Tango";
		sound[]={"\TFP_Music\NewYorkTango.ogg",1,1};
		duration = 247;
		theme = "safe";
		musicClass = "TFP_Music";
		};
	class TFP_Music_73
		{
		name="(TFP) BONUS - Boogie Body";
		sound[]={"\TFP_Music\BoogieBody.ogg",1,1};
		duration = 187;
		theme = "safe";
		musicClass = "TFP_Music";
		};
