...
class TFD_GiletAssautLourd_GIGN : V_PlateCarrierIAGL_oli {
	_generalMacro = "V_PlateCarrierIAGL_oli";
	scope = 2;
	scopeCurator = 2;
	scopeArsenal = 2;
	displayName="Gilet d'assaut lourd (GIGN)";
	author = "Heartbroken";
	hiddenSelections[]= {"camo1","camo2"};
...
class TFD_GiletAssautLourd_RAID : V_PlateCarrierIAGL_oli {
	...
	scopeCurator = 2;
	scopeArsenal = 2;
	displayName="Gilet d'assaut lourd (RAID)";
	author = "Heartbroken";
	hiddenSelections[]= {"camo1","camo2"};
	hiddenSelectionsTextures[]= {"\TFD_Units\Data\Vest\GiletAssaut_RAID.paa","\TFD_Units\Data\Vest\GiletAssautLourd_Noir.paa"};
};
