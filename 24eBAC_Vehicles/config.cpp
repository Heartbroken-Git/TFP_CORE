...
class CfgPatches
{
    class 24eBAC_Vehicles {
        units[] = {"24eBAC_LynxMN_camo","24eBAC_LynxMN_camo_armed","24eBAC_LynxMN","24eBAC_PantherMN","24eBAC_PantherMN_AEM","24eBAC_PantherMN_pedro","24eBAC_PantherMN_armed","24eBAC_VBCI_CE","24eBAC_CamionCE","24eBAC_CamionCE_fuel","24eBAC_VanKaki","24eBAC_VanKaki_container","24eBAC_VanKaki_fuel","24eBAC_VanDGA","24eBAC_VanDGAC","24eBAC_VanLaPoste","24eBAC_VanLaPoste_container","24eBAC_OffroadDGA_securite","24eBAC_OffroadDGAC_followme","24eBAC_OffroadDIR","24eBAC_OffroadTrain","24eBAC_OffroadTrain_CONVEX","24eBAC_PVP_CE","24eBAC_PVP40mm_CE","24eBAC_PVP127mm_CE","24eBAC_VanKaki_PSM","24eBAC_OffroadCoy","24eBAC_OffroadCoy_armed", "24eBAC_OffroadGN","24eBAC_EBG_CE","24eBAC_OffroadCICR","24eBAC_OffroadMSF","24eBAC_OffroadRC","24eBAC_SUVMSF","24eBAC_SUVCICR","24eBAC_Hatchback_CICR","24eBAC_Hatchback_MSF","24eBAC_Hatchback_RC","24eBAC_PantherCICR","24eBAC_CamionCE_nonbache","24eBAC_CamionCE_EVASAN","24eBAC_CamionCiv_MSF","24eBAC_CamionCiv_CICR","24eBAC_CamionCiv_CICRnonbache","24eBAC_VanSable","24eBAC_VanSable_container","24eBAC_VanSable_fuel","24eBAC_VanSable_PSM","24eBAC_VBCI_DA","24eBAC_EBG_DA","24eBAC_PVP_DA","24eBAC_PVP40mm_DA","24eBAC_PVP127mm_DA","24eBAC_OffroadCoyDA","24eBAC_OffroadCoyDA_armed","24eBAC_CamionDA","24eBAC_CamionDA_fuel","24eBAC_CamionDA_nonbache","24eBAC_CamionDA_EVASAN","24eBAC_PantherSAMU","24eBAC_SUVSAMU","24eBAC_Hatchback_SNCF","24eBAC_Hatchback_Securitas","24eBAC_Hatchback_LaPoste","24eBAC_Hatchback_SP","24eBAC_Hatchback_AP","24eBAC_Hatchback_Douane","24eBAC_Hatchback_Vigipirate","24eBAC_Hatchback_GN","24eBAC_UAV_AA","24eBAC_UAVcas_AA","24eBAC_VBRG","24eBAC_VedetteMN"};
        weapons[] = {};
        requiredVersion = 0.1;
        requiredAddons[] = {"A3_Air_F_EPB_Heli_light_03","TFD_Units"}; //Mettre les autres h�licos ici ?
		version = 2.3;
		author = "Heartbroken";
    };
};
...
{
    //Lynx
	class Heli_light_03_unarmed_base_F;  //Classname de l'h�lico modifi�
	...
	//UAV
	class B_UAV_02_F;
	class 24eBAC_UAV_AA:B_UAV_02_F
        {
            _generalMacro = "B_UAV_02_F";
            scope = 2;
            side = 1;
            faction = "TFD_AA";
            displayName="Drone MALE arme";
			author = "Heartbroken";
			crew = "B_UAV_AI";
			hiddenSelections[]= {"camo1"};
	...
	class 24eBAC_UAVcas_AA:B_UAV_02_CAS_F
        {
            _generalMacro = "B_UAV_02_CAS_F";
            scope = 2;
            side = 1;
            faction = "TFD_AA";
            displayName="Drone MALE arme (CAS)";
			author = "Heartbroken";
			crew = "B_UAV_AI";
			hiddenSelections[]= {"camo1"};
			hiddenSelectionsTextures[]= {"\24eBAC_Vehicles\Data\UAV_AA\UAV_AA.paa"};
    ...
    class 24eBAC_VedetteMN:O_Boat_Armed_01_hmg_F {
        _generalMacro = "O_Boat_Armed_01_hmg_F";
        scope = 2;
        side = 1;
        faction = "TFD_MN";
        displayName="Vedette armée";
        author = "Heartbroken";
        crew = "TFD_Marin_TPBpc";
        hiddenSelections[]= {"Camo", "Camo2", "Camo3"};
        hiddenSelectionsTextures[]= {"\24eBAC_Vehicles\Data\Vedette_MN\VedetteMN_ext.paa","\24eBAC_Vehicles\Data\Vedette_MN\VedetteMN_int.paa","\24eBAC_Vehicles\Data\Vedette_MN\VedetteMN_crows.paa"};
        typicalCargo[] = {"TFD_Marin_TPBpc", "TFD_Marin_TPBpc"};
    }
};
