if (isServer) then {
	...
	_this animate ["HideServices", 0];     //yellow roof lights and bullbar and rear rollcage, tools and bits in rear
	_this animate ["HideBackpacks", 1];    //backpacks hanging on side of vehicle
	_this animate ["HideBumper1", 1];      //flat iron bar style bumper
	_this animate ["HideBumper2", 1];      //round bullbar bumper with winch
